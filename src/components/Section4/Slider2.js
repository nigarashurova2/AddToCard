...
import product4 from '../../assets/image/product3.jpg';
import product1 from '../../assets/image/product4.jpg';
import product2 from '../../assets/image/product5.jpg';
...
export default class SimpleSlider extends Component {
  render() {
    ...
    return (
      <div className="container slider-section6 slide2">
        <Slider2 {...settings1}>
          <div className="item" >
